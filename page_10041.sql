...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(37917225381380284875)
,p_plug_name=>'Feedback Submitted'
,p_icon_css_classes=>'fa-check-circle'
,p_region_template_options=>'#DEFAULT#:t-Alert--wizard:t-Alert--customIcons:t-Alert--success'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(37916875844576284447)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37917225201949284875)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(37917225381380284875)
,p_button_name=>'CLOSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37917225473741284875)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(37917225201949284875)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37917235286550284880)
,p_event_id=>wwv_flow_api.id(37917225473741284875)
,p_event_result=>'TRUE'
