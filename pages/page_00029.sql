...
,p_last_upd_yyyymmddhh24miss=>'20210805055553'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24887522343544658232)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(24887522743648658232)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:RP:P30_FOOD_MENU_ID:\#FOOD_MENU_ID#\'
,p_detail_link_text=>'<span aria-label="Edit"><span class="fa fa-edit" aria-hidden="true" title="Edit"></span></span>'
,p_owner=>'OLIURK2@GMAIL.COM'
,p_internal_uid=>24887522743648658232
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24887522808956658233)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24887523206502658233)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24887523678522658234)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24887524040202658234)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24887524492893658234)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24887524873211658234)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(24887418987216189446)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'248874190'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'FOOD_MENU_ID:FOOD_MENU_NAME:PRICE:DESCRIPTION:ACTION_USER:ACTION_DATE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(25760793125614455405)
,p_plug_name=>'Food Menu Report'
,p_region_template_options=>'t-BreadcrumbRegion--showBreadcrumb:t-BreadcrumbRegion--useRegionTitle'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24887525385143658234)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(24887522343544658232)
