...
,p_name=>'Period_wise_guest_serve'
,p_alias=>'PERIOD-WISE-GUEST-SERVE'
,p_step_title=>'Period_wise_guest_serve'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'OLIURK2@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20210918124020'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(34807176689229750911)
...
,p_plug_source=>'<h1 style="color: #3333ff;"><center> Monthly Customer Served <center> </h1>'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(34807176746518750912)
,p_name=>'Monthly Customer sersvered'
...
'select to_char(order_date,''Month YYYY'') Monthly,count(invoice) basket_value',
'from   order_master',
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(34807176882023750913)
,p_query_column_id=>1
...
'',
'',
'<span style="display:block ; width:300px ;color:#THE_COLOR#;font-weight:bold;">#MONTHLY#</span>'))
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(34807176918197750914)
,p_query_column_id=>2
,p_column_alias=>'BASKET_VALUE'
,p_column_display_sequence=>20
,p_column_heading=>'Total Customer Served'
,p_use_as_row_header=>'N'
,p_column_html_expression=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'',
'<span style="display:block ; width:100px ;color:#THE_COLOR#;font-weight:bold;">#BASKET_VALUE#</span>'))
